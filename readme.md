...
<b>backpool</b> is a data structure designed to store data for real-time event processing. It uses pre-allocated memory and provides zero-based historical or 'backward' access to its pool items.
